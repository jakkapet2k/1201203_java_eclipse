...
/**
 * Servlet implementation class UpdateServet
 */
@WebServlet("/Week13.UpdateServlet")
public class UpdateServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		response.getWriter().append("UpdateServlet Served at: ").append(request.getContextPath());
		...
		try {
			...
			// create sql command
			String updateSql = SQLStudent.updateStudentSQL(student);
			// execute sql command
			DBStudent.executeDB(updateSql);
			out.println("</br>");
