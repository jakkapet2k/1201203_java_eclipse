...
public class Menu extends JPanel implements ActionListener {
	...
	public Menu(JFrame frame) {
		...
		JLabel mainLabel = new JLabel("Goods Menu");
		...
		mainLabel.setBounds(153, 36, 87, 21);
		size = addBtn.getPreferredSize();
		addBtn.setBounds(64, 80, 129, 23);
		size = editBtn.getPreferredSize();
		editBtn.setBounds(205, 80, 129, 23);
		size = deleteBtn.getPreferredSize();
		deleteBtn.setBounds(64, 114, 129, 23);
		size = exitBtn.getPreferredSize();
		exitBtn.setBounds(205, 114, 129, 23);
		
		this.setPreferredSize(new Dimension(400, 171));
	}
