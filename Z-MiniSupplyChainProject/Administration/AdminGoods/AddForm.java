...
public class AddForm extends JDialog implements ActionListener {
	...
	public AddForm(JFrame frame) {
		...
		addformlabel.setBounds(122, 32, size.width, size.height);
		...
		idTxt.setBounds(99, 66, 225, 20);
		size = nameTxt.getPreferredSize();
		nameTxt.setBounds(99, 96, 225, 20);
		size = DescriptionTxt.getPreferredSize();
		DescriptionTxt.setBounds(99, 126, 225, 20);
		size = priceTxt.getPreferredSize();
		priceTxt.setBounds(99, 156, 225, 20);
		size = stockTxt.getPreferredSize();
		stockTxt.setBounds(99, 186, 225, 20);

		// set sizes and positions for controls buttons
		size = addBtn.getPreferredSize();
		addBtn.setBounds(29, 217, 172, 23);
		size = cancelBtn.getPreferredSize();
		cancelBtn.setBounds(228, 217, 96, 23);

		// set size and position for container
		pane.setPreferredSize(new Dimension(350, 450));

		scrollPane = new JScrollPane();
		scrollPane.setBounds(29, 247, 295, 174);
