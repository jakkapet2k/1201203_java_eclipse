...
public class Menu extends JPanel implements ActionListener {
	...
	public Menu(JFrame frame) {
		...
		JLabel mainLabel = new JLabel("All Menu");
		...
		this.setPreferredSize(new Dimension(400, 223));
	}
