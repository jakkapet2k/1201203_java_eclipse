...
public class AddForm extends JDialog implements ActionListener{
	...
	public AddForm(JFrame frame) {
		...
		nameLabel.setBounds(29, 156, size.width, size.height);
		...
		nameTxt.setBounds(99, 156, 166, 20);
	...
	public void actionPerformed(ActionEvent evt) {
		...
		if(actionCommand.equals(addString)) {
			...
			try {
				...
				Customer DBcustommer = new Customer(id,user, pass, name);
	...
	private void addCustommer(Customer customer) {
		...
		try {
			String insertSql = "INSERT INTO customer VALUES" + "(" + customer.id + ", '" + customer.user + "', '" + customer.pass + "', '" + customer.name +"')";
