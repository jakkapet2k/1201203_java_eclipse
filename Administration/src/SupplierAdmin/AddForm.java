...
public class AddForm extends JDialog implements ActionListener{
	...
	public void actionPerformed(ActionEvent evt) {
		...
		if(actionCommand.equals(addString)) {
			...
			try {
				...
				Supplier DBgoods = new Supplier(id, name, address, province, phone);
	...
	private void addGoods(Supplier goods) {
		System.out.println("GoodsDB.addGoods()");
		try {
			String insertSql = "INSERT INTO supplier VALUES" + "(" + goods.id + ", '" + goods.name + "', '" + goods.address + "', '" + goods.province + "', '"  + goods.phone + "')";
